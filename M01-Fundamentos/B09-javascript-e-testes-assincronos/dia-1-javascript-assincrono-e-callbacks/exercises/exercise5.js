...
const totalTemperature = getMarsTemperature(); //Criado para não gerar 2 números randômicos para cada chamada de função.

function sendMarsTemperature(callback) {
  setTimeout(() => callback(toFahrenheit(totalTemperature)), messageDelay());
}
